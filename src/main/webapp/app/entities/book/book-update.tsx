...
export interface IBookUpdateProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="mybooksApp.book.home.createOrEditLabel">Create or edit a Book</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
